...
const serviceItems = [
    { img: '/assets/images/file2.png', text: "Assistance to software projects." },
    { img: '/assets/images/file3.png', text: "Assistance for AI works." },
    { img: '/assets/images/file4.png', text: "We build future." },
