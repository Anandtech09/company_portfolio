...
const serviceItems = [
    { img: './public/assets/images/file2.png', text: "Assistance to software projects." },
    { img: './public/assets/images/file3.png', text: "Assistance for AI works." },
    { img: './public/assets/images/file4.png', text: "We build future." },
